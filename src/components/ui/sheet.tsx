  ...
  return (
    <SheetPrimitive.Portal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          'fixed z-50 flex flex-col gap-6 overflow-y-auto overscroll-contain bg-background p-6 shadow-none',
      ...
      >
        {children}
        <SheetPrimitive.Close className="absolute right-4 top-4 grid size-11 place-items-center rounded-[4px] text-foreground transition-colors duration-150 hover:bg-muted hover:text-primary focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring">
